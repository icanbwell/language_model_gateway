    ...
    async with anyio.create_task_group() as tg:
        try:
            ...
            async with aconnect_sse(
                ...
                endpoint_url1 = await tg.start(sse_reader)
                logger.info(f"Starting post writer with endpoint URL: {endpoint_url1}")
                tg.start_soon(post_writer, endpoint_url1)
